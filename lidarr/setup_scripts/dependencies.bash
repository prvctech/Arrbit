...
apk add --no-cache \
  tidyhtml musl-locales musl-locales-lang flac jq git gcc ffmpeg imagemagick opus-tools opustags python3 vorbis-tools parallel npm ripgrep uv
...
# Post-install check
missing=""
for cmd in atomicparsley python3 uv eyed3 yq vorbiscomment metaflac opustags; do
