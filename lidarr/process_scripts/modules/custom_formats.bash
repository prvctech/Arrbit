...
MODULE_ENABLED=$(get_yaml_value &quot;autoconfig.modules.custom_formats&quot;)

# Validate if validator is available
if type validate_boolean >/dev/null 2>&1; then
  if ! validate_boolean &quot;autoconfig.modules.custom_formats&quot; &quot;$MODULE_ENABLED&quot;; then
    MODULE_ENABLED=&quot;false&quot;
  fi
fi

if [[ &quot;${MODULE_ENABLED,,}&quot; != &quot;true&quot; ]]; then
  log_warning &quot;custom_formats module is disabled in configuration. Exiting.&quot;
  exit 0
fi
